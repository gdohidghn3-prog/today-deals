...
/** 올리브영 공식 랭킹 카테고리 (베스트 페이지 fltDispCatNo 파라미터) */
export const OY_CATEGORIES = [
  { code: "10000010001", label: "스킨케어" },
  { code: "10000010009", label: "마스크팩" },
  { code: "10000010010", label: "클렌징" },
  { code: "10000010011", label: "선케어" },
  { code: "10000010002", label: "메이크업" },
  { code: "10000010012", label: "네일" },
  { code: "10000010006", label: "메이크업툴" },
  { code: "10000010008", label: "더모코스메틱" },
  { code: "10000010007", label: "맨즈에딧" },
  { code: "10000010005", label: "향수/디퓨저" },
  { code: "10000010004", label: "헤어케어" },
  { code: "10000010003", label: "바디케어" },
  { code: "10000020001", label: "건강식품" },
  { code: "10000020002", label: "푸드" },
  { code: "10000020003", label: "구강용품" },
  { code: "10000020005", label: "헬스/건강용품" },
  { code: "10000020004", label: "위생용품" },
  { code: "10000030007", label: "패션" },
  { code: "10000030005", label: "홈리빙/가전" },
  { code: "10000030006", label: "취미/팬시" },
];

export function getBestUrl(pageIdx, fltDispCatNo) {
  const base = `https://www.oliveyoung.co.kr/store/main/getBestList.do?dispCatNo=${DISP_CAT}&prdSort=01&pageIdx=${pageIdx}&rowsPerPage=${PAGE_SIZE}`;
  return fltDispCatNo ? `${base}&fltDispCatNo=${fltDispCatNo}` : base;
}
